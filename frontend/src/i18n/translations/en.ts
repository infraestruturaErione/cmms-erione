const locale = {
  ...
  erione_nav_desc_assets: 'Linked cameras and equipment',
  ...
  quick_request_description_placeholder: 'E.g.: camera has no image, equipment is offline, connection failure...',
  ...
  quick_request_no_assets: 'Select a location with cameras/equipment',
  ...
  report_filters_helper:
    'Combine customer, location, camera, status, technician and period to analyze operations.',
  code: 'Code',
  down: 'Down',
  area: 'Area',
  barcode: 'Barcode',
  ...
  allow_selection_from_all_assets:
    'Allow selection from all cameras/equipment',
