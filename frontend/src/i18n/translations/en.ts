const locale = {
  ...
  erione_nav_operation: 'Operations',
  erione_nav_records: 'Records',
  erione_nav_reports: 'Reports',
  erione_nav_admin: 'Administration',
  erione_nav_more: 'More',
  erione_nav_operation_desc: 'Shortcuts for daily field work',
  erione_nav_records_desc: 'Customers, sites and equipment base',
  erione_nav_reports_desc: 'Indicators and management view',
  erione_nav_admin_desc: 'System configuration and parameters',
  erione_nav_more_desc: 'Secondary tools and advanced reports',
  erione_nav_more_operational: 'Advanced operations',
  ...
  erione_nav_desc_quick_request: 'Create a quick service request',
  erione_nav_desc_customers: 'Customers, cities and contractors',
  erione_nav_desc_locations: 'Physical service sites',
  erione_nav_desc_assets: 'Linked equipment/devices',
  erione_nav_desc_people_teams: 'Technicians, users and teams',
  ...
  erione_nav_desc_files: 'Operation files and documents',
  erione_nav_desc_wo_aging: 'Open time and service order aging',
  erione_nav_desc_time_cost: 'Time, costs and order productivity',
  erione_nav_desc_reliability: 'Reliability of monitored equipment',
  erione_nav_desc_asset_cost: 'Consolidated costs by equipment',
  ...
  close: 'Close',
  task_update_success: 'Checklist item updated successfully',
  task_update_failure: "Checklist item couldn't be updated",
  notes_save_success: 'Notes saved successfully',
  images_add_task_success: 'The images have been added to the checklist item',
  ...
  default_work_order_view: 'Default view',
  set_work_order_view_as_default: 'Set this view as default',
  default_work_order_view_saved: 'Default Work Orders view saved',
  default_work_order_view_save_failure:
    'The default Work Orders view could not be saved',
  overdue: 'Overdue',
  ...
  select_location_search_placeholder: 'Search by site, address or code...',
  ...
  unknown: 'Unknown',
  not_filled: 'Not answered yet',
  overview_tab: 'Overview',
  execution_tab: 'Execution',
  field_report_and_evidence_tab: 'Report & Evidence',
  questionnaire_tab: 'Questionnaire',
  questionnaire_section_title: 'Execution questionnaire',
  questionnaire_progress: '{{filled}} of {{total}} items answered',
  questionnaire_empty_title: 'No questionnaire associated',
  questionnaire_empty_description:
    'This work order has no execution questions.',
  task_notes_label: 'Note',
  task_updated_at_only: 'Updated on {{date}}',
  task_updated_at_by: 'Updated by {{name}} • {{date}}',
  task_evidence_more: '+{{count}}',
  none: 'None',
  category_section_basic_info: 'Basic information',
  category_section_planning: 'Planning',
  task_type_tolerance_minutes: 'Tolerance time (minutes)',
  task_type_default_duration: 'Estimated duration',
  ...
  checklist_tag: 'Tag',
  checklist_tag_helper: 'Free-text label, just for your own organization',
  checklist_items_section: 'Checklist items',
  checklist_item_label: 'Question or item',
  checklist_item_label_placeholder: 'e.g. Camera tested and working',
  checklist_item_type: 'Answer type',
  remove_item: 'Remove item',
  assign_item_to: 'Assign to a user or asset',
  copy_items_from_checklist: 'Copy items from an existing checklist',
  ...
  wo_add_location_group_label: 'Address',
  ...
  erione_login_bullet_work_orders:
    'Work orders with priority, owner and due date.',
  erione_login_bullet_field:
    'Field execution with departure, check-in and check-out.',
  ...
  quick_request_auto_title: 'Request - {{customer}} - {{date}}',
  quick_request_files_selected: '{{count}} file(s) selected',
  quick_request_no_locations: 'Select a customer with linked locations',
  quick_request_no_assets: 'Select a location with equipment/devices',
  camera_equipment: 'Equipment/Device',
  ...
  meters: 'Meters',
  people_teams: 'Technicians/Teams',
  people: 'Technicians/Users',
  teams: 'Teams',
  vendors_customers: 'Customers',
  vendors: 'Vendors',
  ...
  operational_work_order_report: 'Operational Work Order Report',
  ...
  bulk_report_history: 'Bulk Reports',
  bulk_report_history_subtitle:
    'Generate reports combining completed work orders from a city and track your request history.',
  bulk_report_download_center_title: 'Report download center',
  bulk_report_download_center_info:
    'After requesting a report, the file stays available for download for 7 days and is then automatically deleted.',
  bulk_report_column_request: 'Request',
  bulk_report_column_description: 'Description',
  bulk_report_column_requested_at: 'Request date',
  bulk_report_column_status: 'Status',
  bulk_report_column_download: 'Download',
  bulk_report_requested_by: 'Requested by {{name}}',
  bulk_report_history_empty: 'No bulk report has been generated yet',
  bulk_report_status_done: 'Done',
  bulk_report_status_processing: 'Processing',
  bulk_report_status_queued: 'Queued',
  bulk_report_status_failed: 'Failed',
  bulk_report_status_expired: 'Expired',
  cnpj: 'CNPJ',
  cnpj_placeholder: '00.000.000/0000-00',
  cnpj_optional_helper: 'Optional for now — will become required in the future',
  ...
  field_execution_details: 'Execution details',
  finalization: 'Finalization',
  field_execution_finalized_line: 'Finished on {{date}} by {{user}}',
  field_report: 'Field report',
  field_report_tab: 'Service report',
  ...
  field_execution_timeline: 'Execution timeline',
  ...
  field_evidence_empty: 'No photos registered',
  ...
  service_finished: 'Check-out completed',
  ...
  check_out_pending: 'Check-out pending',
  evidence_registered: 'Evidence/photos registered',
  evidence_pending: 'Evidence/photos pending',
  ...
  report_filters_helper:
    'Combine customer, location, equipment, status, technician and period to analyze operations.',
  code: 'Code',
  down: 'Down',
  area: 'Area',
  barcode: 'Barcode',
  ...
  no_equipment_in_location: 'No equipment/device linked to this location',
  create_wo_for_location: 'Create Work Order for this site',
  locations_page_subtitle: 'Service points linked to your customers.',
  locations_search_placeholder: 'Search by site, address or customer...',
  locations_all_customers: 'Customer: All',
  clear_filters: 'Clear filters',
  rows_per_page: 'Rows per page',
  locations_results_count: '{{count}} locations found',
  select_customer_for_wo: 'Which customer is this Work Order for?',
  select_customer_for_wo_helper:
    '{{name}} is linked to more than one customer - choose which one to use.',
  select_customer: 'Select customer',
  continue: 'Continue',
  locations_table_local: 'Site',
  locations_table_code: 'Code',
  view_location: 'View site',
  open_location: 'Open site',
  locations_addresses: 'Locations / Addresses',
  open_in_google_maps: 'Open in Google Maps',
  loading: 'Loading...',
  technician: 'Technician',
  create_work_order: 'Create Work Order',
  location_map_future_description:
    'This block prepares the future map visualization of service points, without integrating a real map at this phase.',
  location_map_pending:
    'Real map has not been implemented in this phase. Available coordinates: {{coordinates}}',
  location_history_pending:
    'Consolidated site history is a future improvement. Use the Work Orders tab to view linked services.',
  customer_city: 'Customer/City',
  locations_and_assets: 'Locations & Assets',
  equipment_devices: 'Equipment/Devices',
  equipment_device_information: 'Equipment/Device Information',
  ...
  no_access_vendors_customers:
    "You don't have access to Customers. Please contact your administrator if you should have access",
  ...
  observations: 'Notes',
  locations_with_assets_ratio: '{{withAssets}} of {{total}} sites with assets',
  customer_locations_search_placeholder: 'Search site or address...',
  customer_locations_count: '{{count}} linked sites',
  website: 'Website',
  ...
  customers_page_subtitle: 'Customers and contractors served by the operation.',
  customers_search_placeholder: 'Search customer...',
  customers_results_count: '{{count}} customers found',
  new_customer: 'New customer',
  open_customer: 'Open customer',
  'noRows.customer.message': 'Customers are clients served by the operation',
  ...
  checklist_delete_success:
    'The Service Checklist has been deleted successfully',
  checklist_delete_failure: "The Service Checklist couldn't be deleted",
  create_checklist: 'Create Service Checklist',
  confirm_delete_checklist:
    'Are you sure you want to delete this Service Checklist?',
  upgrade_checklist: 'Please Upgrade to use Service Checklists',
  upgrade_now: 'Upgrade Now',
  total: 'Total',
  sub_task_status: 'Step / task',
  text_field: 'Text',
  number_field: 'Number',
  inspection_check: 'Inspection',
  multiple_choices: 'Option list',
  meter_reading: 'Measurement',
  select_user: 'Select User',
  PASS: 'Passed',
  FLAG: 'Flagged',
  FAIL: 'Failed',
  enter_task_name: 'Enter checklist item name',
  ...
  preview: 'Preview',
  edit_checklist: 'Edit Service Checklist',
  ...
  assign_tasks_description:
    'Assign checklist items for technicians to fill out',
  ...
  ADD_CHECKLIST: 'Add Service Checklist',
  ...
  CHECKLIST_feature: 'Service Checklists',
  ...
  remove_blank_meter_tasks:
    'Remove checklist items with type meter without a meter',
  checklist_update_failure: "The Service Checklist couldn't be edited",
  ...
  'pricing.feature_custom_checklists': 'Custom Service Checklists',
  ...
  'pricing.sh_feature_unlimited_assets_checklists':
    'Unlimited Assets/Service Checklists',
