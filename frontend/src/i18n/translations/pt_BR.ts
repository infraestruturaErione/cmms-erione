const ptBRJSON = {
  ...
  erione_nav_operation: 'Operação',
  erione_nav_records: 'Cadastros',
  erione_nav_reports: 'Relatórios',
  erione_nav_admin: 'Administração',
  erione_nav_more: 'Mais',
  erione_nav_operation_desc: 'Atalhos para a rotina de atendimento',
  erione_nav_records_desc: 'Base de clientes, locais e equipamentos',
  erione_nav_reports_desc: 'Indicadores e visão gerencial da operação',
  erione_nav_admin_desc: 'Configuração e parâmetros do sistema',
  erione_nav_more_desc: 'Ferramentas secundárias e relatórios avançados',
  erione_nav_more_operational: 'Operacional avançado',
  ...
  erione_nav_desc_quick_request: 'Criar solicitação rápida',
  erione_nav_desc_customers: 'Clientes, cidades e contratantes',
  erione_nav_desc_locations: 'Locais físicos atendidos',
  erione_nav_desc_assets: 'Equipamentos/dispositivos vinculados',
  erione_nav_desc_people_teams: 'Técnicos, usuários e equipes',
  ...
  erione_nav_desc_files: 'Arquivos e documentos da operação',
  erione_nav_desc_wo_aging: 'Tempo de abertura e envelhecimento das OS',
  erione_nav_desc_time_cost: 'Tempo, custos e produtividade das ordens',
  erione_nav_desc_reliability: 'Confiabilidade dos equipamentos monitorados',
  erione_nav_desc_asset_cost: 'Custos consolidados por equipamento',
  ...
  close: 'Fechar',
  task_update_success: 'Item do checklist atualizado com sucesso',
  task_update_failure: 'O item do checklist não pôde ser atualizado',
  notes_save_success: 'Notas salvas com sucesso',
  images_add_task_success: 'As imagens foram adicionadas ao item do checklist',
  ...
  default_work_order_view: 'Visualização padrão',
  set_work_order_view_as_default: 'Definir esta visualização como padrão',
  default_work_order_view_saved: 'Visualização padrão das OS salva',
  default_work_order_view_save_failure:
    'Não foi possível salvar a visualização padrão das OS',
  overdue: 'Atrasado',
  ...
  not_filled: 'Ainda não respondida',
  overview_tab: 'Visão Geral',
  execution_tab: 'Execução',
  field_report_and_evidence_tab: 'Relato e Evidências',
  questionnaire_tab: 'Questionário',
  questionnaire_section_title: 'Questionário de execução',
  questionnaire_progress: '{{filled}} de {{total}} itens respondidos',
  questionnaire_empty_title: 'Nenhum questionário associado',
  questionnaire_empty_description:
    'Esta ordem de serviço não possui perguntas de execução.',
  task_notes_label: 'Observação',
  task_updated_at_only: 'Atualizado em {{date}}',
  task_updated_at_by: 'Atualizado por {{name}} • {{date}}',
  task_evidence_more: '+{{count}}',
  none: 'Nenhum',
  category_section_basic_info: 'Informações básicas',
  category_section_planning: 'Planejamento',
  task_type_tolerance_minutes: 'Tempo de tolerância (minutos)',
  task_type_default_duration: 'Duração estimada',
  ...
  checklist_tag: 'Marcador',
  checklist_tag_helper: 'Texto livre, só para sua própria organização',
  checklist_items_section: 'Itens do checklist',
  checklist_item_label: 'Pergunta ou item',
  checklist_item_label_placeholder: 'ex: Câmera testada e funcionando',
  checklist_item_type: 'Tipo de resposta',
  remove_item: 'Remover item',
  assign_item_to: 'Atribuir a um usuário ou equipamento',
  copy_items_from_checklist: 'Copiar itens de um checklist existente',
  ...
  wo_add_location_group_label: 'Endereço',
  ...
  erione_login_bullet_field:
    'Execução em campo com deslocamento, check-in e check-out.',
  erione_login_bullet_reports:
  ...
  quick_request_auto_title: 'Solicitação - {{customer}} - {{date}}',
  quick_request_files_selected: '{{count}} arquivo(s) selecionado(s)',
  quick_request_no_locations: 'Selecione um cliente com locais vinculados',
  quick_request_no_assets: 'Selecione um local com equipamentos/dispositivos',
  camera_equipment: 'Equipamento/Dispositivo',
  ...
  meters: 'Medidores',
  people_teams: 'Técnicos/Equipes',
  people: 'Técnicos/Usuários',
  teams: 'Equipes',
  ...
  operational_work_order_report: 'Relatório Operacional de OS',
  operational_work_order_report_subtitle:
  ...
  bulk_report_column_request: 'Solicitação',
  bulk_report_column_description: 'Descrição',
  bulk_report_column_requested_at: 'Data solicitação',
  bulk_report_column_status: 'Status',
  bulk_report_column_download: 'Download',
  bulk_report_requested_by: 'Solicitado por {{name}}',
  bulk_report_history_empty: 'Nenhum relatório em massa foi gerado ainda',
  bulk_report_status_done: 'Finalizado',
  bulk_report_status_processing: 'Em andamento',
  bulk_report_status_queued: 'Na fila',
  bulk_report_status_failed: 'Falhou',
  ...
  check_in: 'Check-in',
  check_out: 'Check-out',
  check_in_distance: 'Distância check-in',
  check_out_distance: 'Distância check-out',
  ...
  field_execution_details: 'Detalhes da execução',
  finalization: 'Finalização',
  field_execution_finalized_line: 'Finalizada em {{date}} por {{user}}',
  field_report: 'Relato em campo',
  field_report_tab: 'Relato do atendimento',
  ...
  field_execution_status: 'Status da execução',
  field_execution_timeline: 'Linha do tempo da execução',
  ...
  field_evidence_empty: 'Nenhuma foto registrada',
  ...
  service_finished: 'Check-out realizado',
  ...
  check_in_pending: 'Check-in pendente',
  check_out_done: 'Check-out realizado',
  check_out_pending: 'Check-out pendente',
  evidence_registered: 'Evidências/fotos registradas',
  evidence_pending: 'Evidências/fotos pendentes',
  ...
  check_in_longitude: 'Longitude check-in',
  check_in_address: 'Endereço check-in',
  check_out_latitude: 'Latitude check-out',
  check_out_longitude: 'Longitude check-out',
  check_out_address: 'Endereço check-out',
  ...
  report_filters_helper:
    'Combine cliente, local, equipamento, status, técnico e período para analisar a operação.',
  code: 'Codigo',
  down: 'Inoperante',
  area: 'Área',
  ...
  required_location_name: 'A identificação é obrigatória',
  required_location_address: 'O endereço da localização é obrigatório',
  add_location: 'Novo endereço',
  add_location_description:
    'Preencha os campos abaixo para cadastrar um novo endereço de atendimento.',
  edit_location: 'Editar endereço',
  edit_location_description:
    'Atualize as informações deste endereço de atendimento.',
  location_identification_label: 'Identificação',
  location_identification_placeholder:
    'Ex.: Mercado Municipal, Pronto Socorro, CAC',
  location_identification_helper:
    'Como este endereço é reconhecido no dia a dia.',
  more_options: 'Mais opções',
  locations_web_page_title: 'Endereços',
  locations_new_address_button: 'Novo endereço',
  locations_save_button: 'Salvar endereço',
  locations_photo_label: 'Foto do endereço',
  locations_add_photo_button: 'Adicionar foto',
  locations_attachments_label: 'Anexos',
  locations_add_files_button: 'Adicionar arquivos',
  ...
  locations_page_subtitle: 'Gerencie os endereços de atendimento dos clientes.',
  locations_search_placeholder: 'Buscar por ID, endereço ou cliente...',
  locations_all_customers: 'Cliente: Todos',
  clear_filters: 'Limpar filtros',
  clear_customer_filter: 'Limpar filtro de cliente',
  rows_per_page: 'Linhas por página',
  locations_results_count: '{{count}} endereços encontrados',
  ...
  location_map_pending:
    'Mapa real não foi implementado nesta fase. Coordenadas disponíveis: {{coordinates}}',
  ...
  location_coordinates_area: 'Endereço / coordenadas',
  ...
  add_category_description:
    'Configure como as ordens de serviço desta categoria devem ser preparadas e executadas.',
  edit_category: 'Editar categoria',
  edit_category_description:
    'Atualize as configurações operacionais desta categoria.',
  ...
  upgrade_checklist: 'Atualize para usar Checklists de Atendimento',
  //components
  upgrade_now: 'Atualize Agora',
  total: 'Total',
  sub_task_status: 'Etapa / tarefa',
  text_field: 'Texto',
  number_field: 'Número',
  inspection_check: 'Inspeção',
  multiple_choices: 'Lista de opções',
  meter_reading: 'Medição',
  select_user: 'Selecionar Usuário',
  PASS: 'Aprovado',
  FLAG: 'Atenção',
  FAIL: 'Falhou',
  enter_task_name: 'Insira o nome do item',
  ...
  edit_checklist: 'Editar Checklist de Atendimento',
  ...
  assign_tasks_description:
    'Atribuir itens de checklist para técnicos preencherem',
  select_date: 'Selecionar data',
  task: 'Item do checklist',
  checklist: 'Checklist',
  //analytics
  ...
  ADD_CHECKLIST: 'Adicionar Checklist de Atendimento',
  ...
  remove_blank_meter_tasks:
    'Remover itens do checklist do tipo medidor sem um medidor',
  checklist_update_failure: 'O Checklist de Atendimento não pôde ser editado',
  ...
  'pricing.feature_custom_tasks': 'Checklists personalizados',
  ...
  'free_cmms.title':
    'Software CMMS Grátis Erione | Sem necessidade de cartão de crédito',
  ...
  'overview.description':
    'O Erione CMMS é um CMMS gratuito para gerenciar ordens de serviço, manutenção preventiva, ativos e instalações. Simplifique suas operações de manutenção hoje mesmo.',
  'overview.keywords':
    'CMMS, sistema informatizado de gestão de manutenção, EAM, gestão de ativos empresariais, software de manutenção gratuito, gestão de ordens de serviço, manutenção preventiva, rastreamento de ativos, gestão de instalações, software de rastreamento de manutenção, manutenção de equipamentos, Erione CMMS',
  'pricing.title': 'Preços - Erione CMMS',
  'pricing.description':
    'Planos de preços flexíveis para o Erione CMMS. Escolha entre as versões Cloud e Self-Hosted para otimizar suas operações de manutenção.',
  ...
  allow_selection_from_all_assets:
    'Permitir seleção de todos os equipamentos/dispositivos',
