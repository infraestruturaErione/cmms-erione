const ptBRJSON = {
  ...
  none: 'Nenhum',
  task_type_sla_section: 'Nível de serviço',
  ...
  task_type_require_field_report: 'Preencher o relato',
  task_type_require_mileage: 'Preencher km rodado',
  task_type_require_checklist_completion: 'Questionário totalmente preenchido',
