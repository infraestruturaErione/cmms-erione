const ptBRJSON = {
  ...
  erione_nav_desc_assets: 'Câmeras e equipamentos vinculados',
  erione_nav_desc_people_teams: 'Técnicos, usuários e equipes',
  erione_nav_desc_operational_report: 'Cliente, local, câmera e período',
  ...
  quick_request_description_placeholder: 'Ex: câmera sem imagem, equipamento desligado, falha de conexão...',
  ...
  quick_request_no_assets: 'Selecione um local com câmeras/equipamentos',
  camera_equipment: 'Câmera/Equipamento',
  ...
  operational_work_order_report_subtitle:
    'Acompanhe a execucao em campo por cliente, local, camera, status e periodo.',
  ...
  report_filters_helper:
    'Combine cliente, local, câmera, status, técnico e período para analisar a operação.',
  code: 'Codigo',
  down: 'Inoperante',
  area: 'Área',
