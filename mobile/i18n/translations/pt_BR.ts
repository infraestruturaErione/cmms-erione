const ptBRJSON = {
  ...
  home_description:
    'Atendimento em campo, ordens de serviço e execução operacional em um único app.',
  try_grash: 'Acessar Erione CMMS',
  login: 'Entrar',
  erione_mobile_login_subtitle: 'Operação em campo e ordens de serviço',
  ...
  key_features_description:
    'Ferramentas operacionais para equipes, locais, equipamentos e ordens de serviço',
  ...
  'work-orders.descriptions.1':
    'Com o Erione CMMS, sua equipe organiza ordens de serviço, solicitações e tarefas de campo em um ambiente centralizado.',
  ...
  'work-requests.descriptions.1':
    'A solução de gerenciamento de manutenção do Erione CMMS permite que qualquer pessoa autorizada envie um problema para o departamento de manutenção simplesmente escaneando um código QR (código de barras) ou visitando uma URL e digitando sua solicitação através de seus dispositivos móveis.',
  ...
  'eam.descriptions.1':
    'O módulo de Gestão de Ativos Empresariais do Erione CMMS pode ser usado para entre 10 e 1.000.000 de ativos, permitindo que você rastreie exatamente o que deseja, da maneira que deseja, em uma estrutura de árvore fácil de usar e pesquisável.',
  'eam.checks.0':
  ...
  'pm.descriptions.1':
    'O Erione CMMS permite que você automatize facilmente o agendamento de PMs para que o trabalho certo seja entregue automaticamente no momento certo para o técnico certo no ativo certo.',
  'pm.checks.0':
  ...
  'part.descriptions.1':
    'Projetamos o gerenciamento de peças do Erione CMMS para resolver esses problemas e muito mais:',
  'part.checks.0':
  ...
  'dashboard.descriptions.1':
    'Com os Painéis Personalizados do Erione CMMS, você pode finalmente começar a entender o nefasto "buraco negro da manutenção" e começar a colocar planos baseados em dados em ação, resultando em redução de custos de mão de obra, diminuição do tempo de inatividade e muito mais.',
  'dashboard.descriptions.2':
    'Com os Painéis Personalizados do Erione CMMS, você poderá...',
  ...
  'dashboard.checks.4':
    'Visualize relatórios que são facilmente compartilhados via planilhas Excel, PDFs ou dentro do Erione CMMS',
  'dashboard.checks.5': 'E muito mais...',
  'home.smarter': 'Mais Inteligente',
  'home.work': 'Trabalho',
  'home.smarter_description':
    'O Erione CMMS torna incrivelmente fácil para os técnicos trabalharem com eficiência, dando-lhes acesso às ferramentas e dados de que precisam para realizar o trabalho - tudo na palma da mão.',
  leading_maintenance:
  ...
  additional_checklist_items_label: 'Itens adicionais do checklist',
  ...
  mileage_traveled: 'Quilometragem percorrida',
  km: 'km',
  ...
  time: 'Tempo',
  save: 'Salvar',
  customers: 'Clientes/Cidades',
  no_labor:
    'Nenhum custo de mão de obra foi adicionado ainda. Eles aparecerão aqui quando um usuário registrar o tempo e tiver uma taxa horária armazenada no Erione CMMS.',
  ...
  people: 'Pessoas',
  teams: 'Equipes',
  vendors_customers: 'Clientes/Cidades',
  ...
  loading_assets: 'Carregando equipamentos/dispositivos sob {{name}} #{{id}}',
  ...
  assigned_customers: 'Clientes/Cidades atribuídos',
  ...
  //vendors_customers
  Vendors_Customers: 'Clientes/Cidades',
  customer_create_success: 'O cliente/cidade foi criado com sucesso',
  ...
  create_role_description:
    'Esta função pode fazer tudo o que um Administrador pode fazer no Erione CMMS, mas você pode personalizar algumas permissões importantes abaixo.',
  ...
  me: 'Eu',
  remove_blank_tasks: 'Remover itens do checklist em branco',
  remove_blank_options: 'Remover opções em branco',
  preview: 'Pré-visualização',
  edit_checklist: 'Editar Lista de Verificação',
  add_tasks: 'Adicionar itens do checklist',
  use_a_checklist: 'Usar um Checklist de Atendimento',
  select_checklist: 'Selecionar Checklist de Atendimento',
  save_checklist: 'Salvar Checklist de Atendimento',
  assign_tasks_description:
    'Inclua os itens que o técnico deverá preencher durante a execução.',
  ...
  number_users_who_will_use_grash: 'Número de usuários que usarão o Erione CMMS',
  admin_role: 'Admin',
  ...
  workflow_description:
    'Crie fluxos de trabalho personalizados tão fácil quanto Se, E, Então. Economize tempo e atribua facilmente suas ordens de serviço automaticamente por meio de fluxos de trabalho para personalizar o Erione CMMS para a maneira como sua equipe opera.\nTodos os planos podem criar até 1 fluxo de trabalho personalizado. Para adicionar fluxos de trabalho adicionais, atualize para nosso plano de Negócios',
  ...
  downgrade: 'Rebaixar',
  upgrade_description:
    'Você acabou de atualizar seu plano de assinatura. Você precisa habilitar os usuários desabilitados que podem usar o Erione CMMS. Você só pode fazer isso uma vez para a assinatura atual. Por favor, escolha com cuidado',
  ...
  select_locations: 'Selecionar Locais/Endereços',
  select_assets: 'Selecionar Equipamentos/Dispositivos',
  ...
  stats: 'Estatísticas',
  vendors_and_customers: 'Clientes/Cidades',
  ...
  no_assets_available: 'Nenhum equipamento/dispositivo disponível',
  ...
  field_execution_mobile_helper:
    'Acompanhe as etapas do atendimento em campo.',
  my_shift: 'Início',
  my_shift_helper: 'Acompanhe atendimentos em andamento, próximas OS e prioridades do dia.',
  offline_shift_helper: 'Você está offline. Algumas atualizações de campo podem falhar até a conexão voltar.',
  active_service_now: 'Em atendimento agora',
  active_service_now_helper: 'Atendimentos que já possuem execução em andamento.',
  no_active_service_now: 'Nenhuma OS está em execução de campo agora.',
  next_work_order: 'Próxima OS',
  upcoming_work_orders: 'Próximas OS',
  upcoming_work_orders_helper: 'Escolha qual atendimento deseja abrir a seguir.',
  ...
  pending_check_out: 'Check-out pendente',
  pending_completion: 'Conclusão pendente',
  high_priority_or_late: 'Alta prioridade ou atrasada',
  view_all_work_orders: 'Ver todas as OS',
  continue_service: 'Continuar atendimento',
  work_orders_load_error: 'Não foi possível carregar suas OS. Verifique a conexão e tente novamente.',
  not_started: 'Não iniciado',
  en_route: 'Em deslocamento',
  on_site: 'No local',
  field_execution_finished: 'Atendimento de campo encerrado',
  ...
  open_work_order: 'Abrir OS',
  next_action_start_travel_helper: 'Inicie o deslocamento até o local de atendimento.',
  next_action_check_in_helper: 'Confirme a chegada ao local de atendimento.',
  next_action_check_out_helper:
    'Finalize a visita em campo após registrar o atendimento.',
  field_finished_work_order_open_helper:
    'O atendimento no local foi encerrado. Agora finalize os registros da OS.',
  work_order_completed_helper: 'Esta OS já está concluída.',
  next_action_open_work_order_helper: 'Revise os dados da OS.',
  continue_questionnaire: 'Continuar questionário',
  next_action_questionnaire_helper: 'Responda os itens pendentes do questionário.',
  next_action_field_report_helper: 'Registre o relato técnico obrigatório do atendimento.',
  next_action_photo_helper: 'Adicione a evidência fotográfica exigida para esta OS.',
  next_action_closure_details_helper: 'Informe os dados restantes para concluir a OS.',
  next_action_complete_helper: 'Todos os requisitos estão prontos. Revise e conclua a OS.',
  collect_signature: 'Coletar assinatura',
  inform_mileage: 'Informar quilometragem',
  travel_started: 'Deslocamento iniciado',
  check_in_done: 'Check-in realizado',
  check_out_done: 'Check-out realizado',
  field_service_in_progress: 'Atendimento em campo',
  site_duration: 'Tempo no local',
  travel_duration: 'Tempo de deslocamento',
  total_field_duration: 'Tempo total em campo',
  field_time_labor_helper:
    'Tempos calculados pelos eventos de campo; não substituem o tempo de mão de obra.',
  manual_labor_timer: 'Cronômetro de mão de obra',
  manual_labor_timer_helper:
    'Controle administrativo para iniciar ou parar o registro manual de tempo.',
  arrival: 'Chegada',
  on_site_closing: 'Saída / encerramento no local',
  service_summary: 'Resumo do atendimento',
  service_record: 'Registro do atendimento',
  execution_history: 'Histórico da execução',
  execution_history_helper: 'Eventos e horários registrados durante o atendimento.',
  ...
  field_report_pending: 'Relato pendente',
  evidence_registered: 'Evidência registrada',
  ...
  work_order_evidence: 'Evidências da OS',
  work_order_evidence_helper: 'Fotos registradas pelo técnico durante o atendimento.',
  work_order_files_and_evidence: 'Consultar arquivos e evidências',
  work_order_files_and_evidence_helper:
    'Histórico para consulta de anexos administrativos e registros produzidos em campo.',
  work_order_attachment: 'Anexo da OS',
  work_order_attachments_for_technician: 'Arquivos para o atendimento',
  work_order_attachments_for_technician_helper:
    'Materiais enviados pelo administrativo para consulta do técnico.',
  technician_field_evidence: 'Evidências enviadas pelo técnico',
  technician_field_evidence_helper:
    'Fotos e arquivos registrados durante a execução da OS.',
  no_work_order_evidence: 'Nenhuma evidência registrada.',
  file_without_url: 'Arquivo indisponível para abrir',
  work_order_problem: 'Problema',
  work_order_problem_helper: 'Solicitação, observações e dados administrativos.',
  work_order_destination: 'Destino',
  work_order_destination_helper:
    'Cliente, local, endereco e equipamento para chegar sem procurar informacoes.',
  more_details: 'Mais detalhes',
  work_order_more_details_helper:
    'Dados administrativos e campos complementares da OS.',
  no_description: 'Nenhuma descricao informada.',
  show_more: 'Mostrar mais',
  show_less: 'Mostrar menos',
  select_photo: 'Selecionar foto',
  take_photo: 'Tirar foto',
  field_report_photo_only: 'Evidência fotográfica registrada.',
  field_report_save_success: 'Relato em campo salvo',
  field_report_save_error: 'Não foi possível salvar o relato',
  field_report_dialog_title: 'Relato do atendimento',
  field_report_dialog_helper:
    'Descreva de forma objetiva o serviço executado.',
  ...
  field_report_input_helper:
    'Descreva o que foi feito, problema encontrado ou andamento do serviço.',
  add_field_evidence: 'Adicionar evidência',
  field_evidence_input_helper:
    'Tire uma foto ou escolha da galeria. A foto não substitui o relato técnico quando ele for obrigatório.',
  ...
  closing: 'Fechamento',
  closing_requirements: 'Requisitos do fechamento',
  closing_requirements_complete_helper:
    'Registros considerados no fechamento desta OS concluída.',
  completion_progress: '{{completed}} de {{total}} requisitos concluídos',
  ...
  questionnaire_progress: '{{completed}} de {{total}} respondidas',
  question_answered: 'Concluído',
  question_pending: 'Não respondido',
