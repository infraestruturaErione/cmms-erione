const locale = {
  ...
  home_description:
    'Field service, work orders and service execution in one operational app.',
  try_grash: 'Open Erione CMMS',
  login: 'Log In',
  erione_mobile_login_subtitle: 'Field service and work orders',
  ...
  key_features_description:
    'Operational tools for service teams, assets, locations and work orders',
  ...
  'work-orders.descriptions.1':
    'With Erione CMMS you can organize work orders, requests and field tasks in a central workspace available from any device.',
  ...
  'work-requests.descriptions.1':
    'Erione CMMSâ€™s maintenance management solution allows anyone you authorize to submit a problem to your maintenance department by simply scanning a QR code (bar code) or visiting a URL and typing in their request through their mobile devices.',
  ...
  'eam.descriptions.0':
    'Frustrated with trying to organize the chaotic mess of companyâ€™s equipment, wondering if the equipment has been properly taken care of, not knowing what they cost to maintain and all the other headaches that come with managing assets?',
  'eam.descriptions.1':
    'Erione CMMSâ€™s Enterprise Asset Management module can be used for anywhere between 10 to 1,000,000 Assets, allowing you to track exactly what you want, the way you want to, in an easy-to-use and searchable tree structure.',
  'eam.checks.0':
  ...
  'pm.descriptions.1':
    'Erione CMMS allows you to easily automate PM scheduling so the right work is automatically delivered at the right time to the right technician for the right Asset.',
  'pm.checks.0':
  ...
  'pm.checks.4':
    'Upon PM completion, the work is automatically logged in the assetâ€™s maintenance log..',
  ...
  'part.descriptions.0':
    'Not sure what parts you have in stock or where they are being used? Donâ€™t know when your parts will run out or if your technicians will have the necessary parts to do their jobs?',
  'part.descriptions.1':
    'We designed Erione CMMSâ€™s parts management to solve those problems and more:',
  'part.checks.0':
    'Get instant push and email notifications when a partâ€™s quantity is low. Keep the right number of parts in stock by receiving instant and automatic push/email notifications when the quantity of a part is below a custom set threshold.',
  'part.checks.1':
  ...
  'dashboard.descriptions.0':
    'Letâ€™s face it, the first step to improving your operations is to know the good, the bad and the ugly.',
  'dashboard.descriptions.1':
    'With Erione CMMSâ€™s Custom Dashboards you can finally start to understand that nefarious â€œblack hole of maintenanceâ€ and begin putting data-backed plans into action, resulting in reduced labor costs, decreased downtime and more.',
  'dashboard.descriptions.2': 'With Erione CMMSâ€™s Custom Dashboards youâ€™ll get to â€¦',
  ...
  'dashboard.checks.4':
    'View reports that are easily shared via Excel sheets, PDFs or within Erione CMMS',
  'dashboard.checks.5': 'And so much more ...',
  'home.smarter': 'Smarter',
  'home.work': 'Work',
  'home.smarter_description':
    'Erione CMMS makes it incredibly easy for technicians to work efficiently by giving them access to the tools and data they need to get work done â€” all from the palm of their hand.',
  leading_maintenance:
  ...
  additional_checklist_items_label: 'Additional checklist items',
  distance_from_location: '{{distance}} from the expected location',
  signer_name: 'Signer name',
  signer_document: 'Signer document (ID/Tax ID)',
  ...
  time: 'Time',
  save: 'Save',
  customers: 'Customers/Cities',
  no_labor:
    "No labor costs have been added yet. They'll show up here when a user logs time and has an hourly rate stored in Erione CMMS.",
  ...
  people: 'People',
  teams: 'Teams',
  vendors_customers: 'Customers/Cities',
  vendors: 'Vendors',
  ...
  'Floor plan area in mÂ²': 'Floor plan area in mÂ²',
  ...
  assigned_customers: 'Assigned Customers/Cities',
  ...
  //vendors_customers
  Vendors_Customers: 'Customers/Cities',
  customer_create_success: 'The customer/city has been created successfully',
  ...
  create_role_description:
    'This role can do everything an Administrator can do in Erione CMMS, but you can customize some important permissions below.',
  ...
  me: 'Me',
  remove_blank_tasks: 'Remove blank checklist items',
  remove_blank_options: 'Remove blank options',
  preview: 'Preview',
  edit_checklist: 'Edit Checklist',
  add_tasks: 'Add checklist items',
  use_a_checklist: 'Use a Service Checklist',
  select_checklist: 'Select Service Checklist',
  save_checklist: 'Save Service Checklist',
  assign_tasks_description:
    'Add the items the technician must complete during execution.',
  ...
  workflow_description:
    'Create custom workflows as easy as If, And, Then. Save time and easily assign your work orders automatically through workflows to customize Erione CMMS for the way your team operates.\nAll plans can create up to 1 custom workflow. To add additional workflows, upgrade to our Business plan',
  ...
  downgrade: 'Downgrade',
  upgrade_description:
    'You just upgraded your subscription plan. You need to enable the disabled users who might use Erione CMMS. You can only do this once for the current subscription. Please choose carefully',
  ...
  select_locations: 'Select Locations/Addresses',
  select_assets: 'Select Equipment/Devices',
  ...
  stats: 'Stats',
  vendors_and_customers: 'Customers/Cities',
  ...
  field_execution_mobile_helper:
    'Follow each stage of the field service.',
  my_shift: 'Home',
  my_shift_helper: 'Track active service, upcoming Work Orders and daily priorities.',
  offline_shift_helper: 'You are offline. Some field updates may fail until the connection returns.',
  active_service_now: 'Active service now',
  active_service_now_helper: 'Services that already have field execution in progress.',
  no_active_service_now: 'No Work Order is currently in field execution.',
  next_work_order: 'Next Work Order',
  upcoming_work_orders: 'Upcoming Work Orders',
  upcoming_work_orders_helper: 'Choose which service you want to open next.',
  ...
  pending_check_out: 'Pending check-out',
  pending_completion: 'Pending completion',
  high_priority_or_late: 'High priority or late',
  view_all_work_orders: 'View all Work Orders',
  continue_service: 'Continue service',
  work_orders_load_error: 'Could not load your Work Orders. Check the connection and try again.',
  not_started: 'Not started',
  en_route: 'En route',
  on_site: 'On site',
  field_execution_finished: 'Field service ended',
  ...
  next_action_start_travel_helper: 'Start the route to the service location.',
  next_action_check_in_helper: 'Confirm arrival at the service location.',
  next_action_check_out_helper: 'Finish the field visit after recording the service.',
  field_finished_work_order_open_helper:
    'On-site service has ended. Now finish the Work Order records.',
  work_order_completed_helper: 'This Work Order is already complete.',
  next_action_open_work_order_helper: 'Review the Work Order details.',
  continue_questionnaire: 'Continue questionnaire',
  next_action_questionnaire_helper: 'Answer the pending questionnaire items.',
  next_action_field_report_helper: 'Record the required technical field report.',
  next_action_photo_helper: 'Add the photo evidence required for this Work Order.',
  next_action_closure_details_helper: 'Enter the remaining details to complete the Work Order.',
  next_action_complete_helper: 'All requirements are ready. Review and complete the Work Order.',
  collect_signature: 'Collect signature',
  inform_mileage: 'Enter mileage',
  travel_started: 'Travel started',
  check_in_done: 'Check-in completed',
  check_out_done: 'Check-out completed',
  field_service_in_progress: 'Field service',
  site_duration: 'Time on site',
  travel_duration: 'Travel time',
  total_field_duration: 'Total field time',
  field_time_labor_helper:
    'Times calculated from field events; they do not replace labor time.',
  manual_labor_timer: 'Labor timer',
  manual_labor_timer_helper:
    'Administrative control to start or stop manual time tracking.',
  arrival: 'Arrival',
  on_site_closing: 'Departure / on-site closing',
  service_summary: 'Service summary',
  service_record: 'Service record',
  execution_history: 'Execution history',
  execution_history_helper: 'Events and timestamps recorded during the service.',
  work_order_created: 'Work Order created',
  completed_step: 'Completed',
  pending_step: 'Pending',
  field_report: 'Field report',
  field_report_registered: 'Field report registered',
  field_report_pending: 'Field report pending',
  ...
  work_order_evidence_helper: 'Photos recorded by the technician during service.',
  work_order_files_and_evidence: 'View files and evidence',
  work_order_files_and_evidence_helper:
    'History of office attachments and records produced in the field.',
  work_order_attachment: 'Work Order attachment',
  work_order_attachments_for_technician: 'Files for the service',
  work_order_attachments_for_technician_helper:
    'Materials sent by the office for the technician to consult.',
  technician_field_evidence: 'Evidence sent by the technician',
  technician_field_evidence_helper:
    'Photos and files recorded while executing the Work Order.',
  no_work_order_evidence: 'No evidence registered.',
  file_without_url: 'File unavailable to open',
  work_order_problem: 'Problem',
  work_order_problem_helper: 'Request, notes and administrative details.',
  work_order_destination: 'Destination',
  work_order_destination_helper:
    'Customer, location, address and asset so the technician can get there without hunting for details.',
  more_details: 'More details',
  work_order_more_details_helper:
    'Administrative data and complementary Work Order fields.',
  no_description: 'No description provided.',
  show_more: 'Show more',
  show_less: 'Show less',
  select_photo: 'Select photo',
  take_photo: 'Take photo',
  field_report_photo_only: 'Photo evidence registered.',
  field_report_save_success: 'Field report saved',
  field_report_save_error: 'Unable to save the field report',
  field_report_dialog_title: 'Service report',
  field_report_dialog_helper:
    'Describe the service performed in a clear and objective way.',
  field_report_placeholder:
    'Example: Replaced the motor bearing, aligned the assembly and completed an operational test with no issues.',
  field_report_read_only_helper:
    'This report was registered by another user and is available for viewing only.',
  discard_field_report_title: 'Discard unsaved report?',
  discard_field_report_message: 'Changes made to the report will be lost.',
  keep_editing_field_report: 'Keep editing',
  discard: 'Discard',
  save_field_report: 'Save report',
  view_report: 'View report',
  add_field_report: 'Add field report',
  field_report_input_helper:
    'Describe what was done, the issue found, or the service progress.',
  add_field_evidence: 'Add evidence',
  field_evidence_input_helper:
    'Take a photo or choose one from the gallery. A photo does not replace the technical report when it is required.',
  ...
  closing_requirements_complete_helper:
    'Records considered when this completed Work Order was closed.',
  completion_progress: '{{completed}} of {{total}} requirements completed',
  ...
  signature_requested_on_completion:
    'It will be collected during closing.',
  ...
  questionnaire_progress: '{{completed}} of {{total}} answered',
  question_answered: 'Completed',
  question_pending: 'Not answered',
